    ...
    100: function (e, t) {
        !function (n) {
            ...
            'function' == typeof define && define.amd ? define(['angular',
                './Sortable'], n)  : 'function' == typeof require && 'object' == typeof t && 'object' == typeof e ? (require('angular'), n(angular, require('./Sortable')), e.exports = 'ng-sortable')  : window.angular && window.Sortable && n(angular, Sortable)
        }(function (e, t) {
            'use strict';
            var n = 'Sortable:ng-sortable';
            e.module('ng-sortable', [
            ]).constant('ngSortableVersion', '0.4.0').constant('ngSortableConfig', {
                ...
                function (a, r) {
                    ...
                    return {
                        ...
                        link: function (o, s) {
                            var u,
                                l = s[0],
                                d = e.extend(o.ngSortable || {
                                }, r),
                                f = [
                                ],
                                h = function (e, t) {
                                    var n = [
                                    ].filter.call(e.childNodes, function (e) {
                                        return 8 === e.nodeType && - 1 !== e.nodeValue.indexOf('ngRepeat:')
                                    }) [0];
                                    if (!n) return function () {
                                        return null
                                    };
                                    n = n.nodeValue.match(/ngRepeat:\s*(?:\(.*?,\s*)?([^\s)]+)[\s)]+in\s+([^\s|]+)/);
                                    var r = a(n[2]);
                                    return function () {
                                        return r(t.$parent) || [
                                        ]
                            ...
                            function p(a) {
                                ...
                                if (r) {
                                    ...
                                    if (l !== a.from) {
                                        var d = a.from[n]();
                                        i = d[s],
                                            a.clone ? (i = e.copy(i), d.splice(t.utils.index(a.clone), 0, d.splice(s, 1) [0]), a.from.removeChild(a.clone))  : d.splice(s, 1),
                                            r.splice(u, 0, i),
                                            a.from.insertBefore(a.item, c)
                                    } else r.splice(u, 0, r.splice(s, 1) [0]);
                                    o.$apply()
                                }
                            }
                            l[n] = h,
                                u = t.create(l, Object.keys(d).reduce(function (e, t) {
                                    return e[t] = e[t] || d[t],
                                        e
                                }, {
                                    onStart: function (e) {
                                ...
                                e.forEach(['sort',
                                    ...
                                    'onRemove',
                                    'onSort'], function (e) {
                                    f.push(o.$watch('ngSortable.' + e, function (t) {
                                        void 0 !== t && (d[e] = t, /^on[A-Z]/.test(e) || u.option(e, t))
                                    }))
                                })
                        }
                    }
     ...
     */
        !function () {
            ...
            var e = 8,
                ...
                c = 40,
                o = 188,
                s = angular.module('ngTagsInput', [
                ]);
            s.directive('tagsInput', [
                '$timeout',
                '$document',
                'tagsInputConfig',
                function (t, a, i) {
                            ...
                            function (e, t, n) {
                                ...
                                i.load('tagsInput', e, t, {
                                    ...
                                    e.tryAdd = function () {
                                        var t = !1,
                                            n = e.newTag;
                                        return n.length >= e.options.minLength && e.options.allowedTagsPattern.test(n) && (e.options.replaceSpacesWithDashes && (n = n.replace(/\s/g, '-')), - 1 === e.tags.indexOf(n) && (e.tags.push(n), e.events.trigger('tag-added', {
                                            $tag: n
                                        })), e.newTag = '', e.events.trigger('input-change', ''), t = !0),
                                            t
                                    },
                                    e.tryRemoveLast = function () {
                                        var t = !1;
                                        return e.tags.length > 0 && (e.options.enableEditingLastTag ? e.newTag = e.remove(e.tags.length - 1)  : a ? (e.remove(e.tags.length - 1), a = !1)  : a = !0, t = !0),
                                            t
                                    },
                                    e.remove = function (t) {
                                        var n = e.tags.splice(t, 1) [0];
                                        return e.events.trigger('tag-removed', {
                                            $tag: n
                                        }),
                                            n
                                    },
                                    ...
                                    this.registerAutocomplete = function () {
                                        var t = n.find('input');
                                        return t.on('keydown', function (t) {
                        ...
                        link: function (i, c, s, u) {
                            ...
                            d.on('keydown', function (t) {
                                if (!t.isImmediatePropagationStopped || !t.isImmediatePropagationStopped()) {
                                    var a = t.keyCode;
                                    t.shiftKey || t.altKey || t.ctrlKey || t.metaKey || - 1 === l.indexOf(a) || (a === n && i.options.addOnEnter || a === o && i.options.addOnComma || a === r && i.options.addOnSpace ? (i.tryAdd() && i.$apply(), t.preventDefault())  : a === e && 0 === this.value.length && i.tryRemoveLast() && (i.$apply(), t.preventDefault()))
                                }
                            }).on('focus', function () {
                                i.hasFocus || (i.hasFocus = !0, i.$apply())
                            }).on('blur', function () {
                                t(function () {
                                    angular.element(a[0].activeElement).parent() [0] !== c[0] && (i.hasFocus = !1, i.options.addOnBlur && i.tryAdd(), i.events.trigger('input-blur'), i.$apply())
                                }, 0, !1)
                            }),
                                ...
                                i.$watch('tags.length', function () {
                                    u.$setValidity('maxTags', angular.isUndefined(i.options.maxTags) || i.tags.length <= i.options.maxTags),
                                        u.$setValidity('minTags', angular.isUndefined(i.options.minTags) || i.tags.length >= i.options.minTags)
                                })
                        }
                    }
                }
            ]),
                s.directive('autoComplete', [
                    '$document',
                    '$timeout',
                    '$sce',
                    'tagsInputConfig',
                                ...
                                s.load('autoComplete', u, d, {
                                    ...
                                    h = new function (e, t) {
                                        ...
                                        return a = function (e, t) {
                                            ...
                                            c.load = function (o, s) {
                                                o.length < t.minLength ? c.reset()  : (r.cancel(n), n = r(function () {
                                                    c.query = o;
                                                    var t = e({
                                                        $query: o
                                                    });
                                                    i = t,
                                                        t.then(function (e) {
                                                            t === i && (c.items = a(e.data || e, s), c.items.length > 0 ? c.show()  : c.reset())
                                                        })
                                                }, t.debounceDelay, !1))
                                            },
                                    ...
                                    p = u.options.highlightMatchedText ? function (e, t) {
                                    ...
                                    u.suggestionList = h,
                                    u.addSuggestion = function () {
                                        var e = !1;
                                        return h.selected && (b.tryAddTag(h.selected), h.reset(), b.focusInput(), e = !0),
                                            e
                                    },
                                    u.highlight = function (e) {
                                        return e = p(e, h.query),
                                            e = (e = e.replace(/&/g, '&amp;').replace(/</g, '&lt;').replace(/>/g, '&gt;')).replace(/\*\*(.+?)\*\*/g, '<em>$1</em>'),
                                            o.trustAsHtml(e)
                                    },
                                    b.on('input-change', function (e) {
                                        e ? h.load(e, b.getTags())  : h.reset()
                                    }).on('input-keydown', function (e) {
                                        var r,
                                            o;
                                        if ( - 1 !== g.indexOf(e.keyCode)) {
                                            var s = !1;
                                            ...
                                            h.visible && (o = !1, (r = e.keyCode) === c ? (h.selectNext(), o = !0)  : r === i ? (h.selectPrior(), o = !0)  : r === a ? (h.reset(), o = !0)  : r !== n && r !== t || (o = u.addSuggestion()), o && (e.preventDefault(), e.stopImmediatePropagation(), u.$apply()))
                                        }
                                    }).on('input-blur', function () {
                                        h.reset()
                                    }),
                                    e.on('click', function () {
                                        h.visible && (h.reset(), u.$apply())
                                    })
                            }
                        }
                    }
                ]),
                s.directive('tiTranscludeAppend', function () {
                    ...
                    function (e) {
                        return {
                            ...
                            link: function (t, n, a, r) {
                                var i,
                                    c;
                                (i = angular.element('<span class="tag-input"></span>')).css('display', 'none').css('visibility', 'hidden').css('width', 'auto'),
                                    n.parent().append(i),
                                    c = function (e) {
                                        var t = e;
                                        angular.isString(e) && 0 === e.length && (e = n.attr('placeholder')),
                                            i.text(e),
                                            i.css('display', '');
                                        try {
                ...
                s.provider('tagsInputConfig', function () {
                    var e = {
                    };
                                    ...
                                    },
                                    {
                                        load: function (a, r, i, c) {
                                            r.options = {
                                                ...
                                                angular.forEach(c, function (c, o) {
                                                    var s = i[o] && t(i[o]) (r.$parent),
                                                        u = n[c[0]];
                                                    r.options[o] = s ? u(s)  : function (t) {
                                                        var n = e[a] && e[a][t];
    ...
    99: function (e, t) {
            ...
            e.defaults.headers.post['Content-Type'] = 'application/x-www-form-urlencoded',
                e.defaults.transformRequest.unshift(function (e) {
                    if (!angular.isUndefined(e)) {
                        ...
                        return e.xf = window.xf(),
                            angular.forEach(e, function (e, n) {
                                e && n && (angular.isFunction(e) && (e = e()), n = encodeURIComponent(n), e = encodeURIComponent(e), t.push(n + '=' + e))
                            }),
                            t.join('&')
                    }
                })
        ...
        function a(e) {
            return {
                ...
                template: function (e, t) {
                    return 'textarea' === t.type ? '<div class="placeholder"><textarea ng-model="input" class="input text" ng-class="visibility" ng-blur="blur()"></textarea><span class="text hint" ng-bind="placeholder" ng-hide="hideHint" ng-click="focus($event)"></span></div>' : '<div class="placeholder"><input type="text" ng-model="input" class="input text" ng-class="visibility" ng-blur="blur()"><span class="text hint" ng-bind="placeholder" ng-hide="hideHint" ng-click="focus($event)"></span></div>'
                },
                replace: !0,
                link: function (t, n, a, r) {
                    var i = n.find('.input');
                    e(function () {
                        ...
                        t.hideHint ? t.visibility = 'visible' : t.visibility = 'invisible',
                        t.focus = function (n) {
                            n.preventDefault(),
                                t.hideHint = !0,
                        ...
                        t.blur = function () {
                            ...
                            t.hideHint || (t.visibility = 'invisible'),
                                t.onBlur()
                        },
                        t.$watch('input', function (e) {
                            e && (t.hideHint = !0, t.visibility = 'visible')
                        })
                }
            }
        }
        ...
        function i(e, t, n) {
            ...
            return {
                ...
                getRecipeDraft: function (e) {
                    return t.get('/recipe_draft/' + e + '/show/')
                },
                getIngsRecommend: function n(r) {
                    r = angular.element.trim(r);
                    var i = a[r];
                    ...
                    return t.post('/recipe/recipe_ings_recommend/', {
                        ...
                        return a[r] = e.data.content.ings,
                            n(r)
                    })
                },
                uploadFile: function (e) {
                    ...
                    return a.append('file', e),
                        ...
                        t({
                            ...
                            if (e.data.content) return e.data.content;
                            throw e
                        })
                },
                ...
                updateRecipe: function (e, n) {
                    var a = '/recipe/' + e + '/update/';
                    return t.post(a, {
                        recipe: n
                    })
                },
                updateStash: function (e, n) {
                    return t.post('/recipe/stash/', {
                        recipe_id: e,
                        stash: n
                    })
                },
                createRecipeDraft: function (e) {
                    return t.post('/recipe_draft/create/', {
                        name: angular.fromJson(e).name || '无标题菜谱',
                        content: e
                    })
                },
                updateRecipeDraft: function (e, n) {
        ...
        function c(e, t, n, a, r, i, c, o, s, u) {
            var l,
                d,
                f,
                h = /custom_recipe/gi.test(location.href);
            if (e.recipeId = '', e.recipeDraftId = '', '/recipe/create/' === location.pathname) {
                var b = location.search.slice(1).split('&');
                angular.forEach(b, function (t) {
                    var n = t.indexOf('=');
                    'recipe_draft_id' === t.slice(0, n) && (e.recipeDraftId = t.slice(n + 1))
                })
            } else e.recipeId = location.pathname.split('/') [2];
            function p() {
                if (!(e.saveStashPending || e.publishPending || e.activatePending)) {
                    var t = k();
                    if (!angular.equals(angular.toJson(t), angular.toJson(d))) if (e.recipeId || e.recipeDraftId || !angular.equals(e.recipe, s)) d = t,
                        e.saveStashPending = !0,
                        ('/recipe/create/' === location.pathname ? e.recipeDraftId ? o.updateRecipeDraft(e.recipeDraftId, d)  : o.createRecipeDraft(d).then(function (t) {
                            e.recipeDraftId = t.data.content.id
                        })  : o.updateStash(e.recipeId, d)).catch (function () {
                            alert('保存失败')
                        }).finally (function () {
                            e.saveStashPending = !1
                        })
                }
            }
            e.TRANSCODE_STATUS = u,
                e.recipe = angular.copy(s),
            h && (e.recipe.allow_adaptation = !1),
                e.hasStash = !1,
                e.ingsRecommend = [
                ],
                e.isSortingIngs = !1,
                ...
                e.multipleUploading = !1,
                e.multipleSelectKey = - 1 === navigator.userAgent.indexOf('Mac OS X') ? 'Ctrl' : '⌘',
                e.isMultipleUploadSupported = ((l = document.createElement('input')).type = 'file', 'multiple' in l && 'FormData' in n),
                e.saveStashPending = !1,
                e.publishPending = !1,
                e.activatePending = !1,
                e.vodVideoUrl = '',
                e.canUploadThirdPartyVideo = n.can_upload_third_party_video,
                e.showVideoAddress = !1,
                e.uploadVideoProgress = '',
                e.uploadVideoPending = !1,
                e.addEmptyIng = function () {
                    C({
                        name: '',
                        unit: ''
                    })
                },
                e.addRecommendIng = function (t) {
                    C(t),
                        E(e.ingsRecommend, t)
                },
                e.addEmptyStep = S,
                e.autocomplete = function (e) {
                    var r = $.Deferred(),
                        i = a('filter') (n.availiable_cats, e);
                    return t(function () {
                        r.resolve(i)
                    }, 0),
                        r.promise()
                },
                e.multipleUploadStepsPics = function (n) {
                    if (e.multipleUploading) return;
                    var a = n.target.files;
                    if (!a.length) return;
                    e.multipleUploading = !0,
                        i.all(angular.element.map(a, o.uploadFile)).then(function (n) {
                            var a = 0,
                                r = e.recipe.steps[a];
                            angular.forEach(n, function (t, n) {
                                for (; r.pic_ident && r.picurl; ) (a += 1) === e.recipe.steps.length && S(),
                                    r = e.recipe.steps[a];
                                r.pic_ident = t.ident,
                                    r.picurl = t.url
                            }),
                ...
                e.publish = function (t, a) {
                    if (a.preventDefault(), t && e.saveStashPending) return;
                    if (!t && e.publishPending) return;
                    if (!t) {
                        var i = m();
                        if (i.length) return void alert(i.join('\n'))
                    }
                    var c,
                        s = k(!t);
                    t ? (e.saveStashPending = !0, c = e.recipeId ? o.updateStash(e.recipeId, s)  : e.recipeDraftId ? o.updateRecipeDraft(e.recipeDraftId, s)  : o.createRecipeDraft(s))  : (e.publishPending = !0, c = e.recipeId ? o.updateRecipe(e.recipeId, s)  : e.recipeDraftId ? o.createRecipe(s).then(function (t) {
                        if ('ok' !== t.data.status) {
                    ...
                    c.then(function (e) {
                        ...
                        alert(n.message || '创建菜谱失败'),
                            t ? e.saveStashPending = !1 : e.publishPending = !1
                    })
                },
                e.removeIng = function (t) {
                    E(e.recipe.ings, t)
                },
                e.removeStep = function (t) {
                    if ((t.text || t.picurl || t.pic_ident) && !confirm('你真的要删除这一步骤吗？')) return;
                    E(e.recipe.steps, t)
                },
                e.updateIngsRecommend = function () {
                    if (!e.recipe.name) return;
                    o.getIngsRecommend(e.recipe.name).then(function (t) {
                        angular.forEach(e.recipe.ings, function (e) {
                            angular.forEach(t, function (n, a) {
                                e.name === n.name && t.splice(a, 1)
                            })
                        }),
                            e.ingsRecommend = t
                    })
                },
                e.deleteRecipeDraft = function () {
                ...
                e.startUploadVideo = D,
                e.confirmDeleteVideo = function () {
                    if (!confirm('你真的要要删除视频吗？删除后视频将无法恢复')) return;
                    T()
                },
                e.confirmReselectVideo = function () {
                    if (!confirm('你真的要重新选择视频吗？这将删除你之前上传的视频')) return;
                    D()
                },
                e.toggleVideoAddress = function () {
                    e.showVideoAddress = !e.showVideoAddress
                },
                e.disabledUpdateAllowAdaptation = h,
                e.$watch('recipe.vod_video', function (t) {
                    e.vodVideoUrl = t.universal_player_url,
                    e.vodVideoUrl && e.recipe.cover_ident && (e.vodVideoUrl += '?cover_ident=' + e.recipe.cover_ident),
                        e.vodVideoUrl = c.trustAsResourceUrl(e.vodVideoUrl),
                        e.recipe.vod_id = t.id || ''
                }),
                function () {
                    if (f = r(p, 5000), !e.recipeId && !e.recipeDraftId) return void t(n.setupUploadWidget);
                    e.activatePending = !0,
                        function () {
                            if (e.recipeId) return o.getRecipe(e.recipeId).then(function (t) {
                                if ('ok' !== t.data.status) throw t.data;
                                var n = t.data.content.stash;
                                return e.hasStash = n && !angular.equals(n, {
                                }),
                                    angular.extend(t.data.content.recipe, t.data.content.stash)
                            });
                            if (e.recipeDraftId) return o.getRecipeDraft(e.recipeDraftId).then(function (e) {
                                if ('ok' !== e.data.status) throw e.data;
                                return e.data.content.draft
                            })
                        }().then(function (a) {
                            e.recipe = {
                                name: '无标题菜谱' === a.name ? '' : a.name,
                                desc: a.desc || '',
                                cover_ident: a.image.ident || '',
                                video_ident: a.vod_video.video_ident || '',
                                picurl: x(a.image) || '',
                                ings: angular.element.map(a.ingredients, function (e) {
                                    return {
                                        name: e.name,
                                        unit: e.amount
                                    }
                                ...
                                steps: angular.element.map(a.instructions, function (e) {
                                    return {
                                        text: e.text,
                                ...
                                allow_adaptation: a.adaptation ? a.adaptation.allow_adaptation : s.allow_adaptation
                            },
                                e.activatePending = !1,
                            e.recipe.video_address && (e.showVideoAddress = !0, e.canUploadThirdPartyVideo = !0),
                            a.is_adaptation_recipe && (e.disabledUpdateAllowAdaptation = !0, e.recipe.allow_adaptation = !0),
                            ...
                            e && e.msg ? alert(angular.isArray(e.msg) ? e.msg.join('\n')  : e.msg)  : confirm('获取数据失败，是否刷新重试？') && location.reload()
                        })
                }();
            var g = function (e) {
                    return function (e) {
                        for (var t, n = e.length - 1; n >= 0 && (t = e[n], !$.trim(t.name) && !$.trim(t.unit)); n--) E(e, e[n])
                    }((e = angular.fromJson(angular.toJson(e))).ings),
                        function (e) {
                            for (var t, n = e.length - 1; n >= 0 && (t = e[n], !($.trim(t.pic_ident) || $.trim(t.text) || $.trim(t.pic_ident))); n--) E(e, e[n])
                        }(e.steps),
                        e
                },
                m = function () {
                    ...
                    return $.trim(t.name) ? $.trim(t.name).length > 128 && n.push('菜谱名最多为 128 字')  : n.push('菜谱名不能为空'),
                    $.trim(t.desc).length > 2000 && n.push('菜谱简介最多为 2000 字'),
                    $.trim(t.cover_ident) || n.push('菜谱封面不能为空'),
                    v(t.ings) || n.push('菜谱用料不能为空，且不超过 120 字'),
                    y(t.steps) || n.push('菜谱步骤不能为空，且不超过 1000 字'),
                    w(t.video_address) || n.push('视频 Flash 地址错误'),
                        n
                },
                v = function (e) {
                    for (var t = e.length - 1; t >= 0; t--) {
                        var n = $.trim(e[t].name);
                        if (!n || n.length > 120) return !1
                    }
                    return !0
                },
                y = function (e) {
                    for (var t = e.length - 1; t >= 0; t--) {
                        var n = $.trim(e[t].text);
                        if (!n || n.length > 1000) return !1
                    }
                    return !0
                },
                w = function (e) {
                    return !e.length || !!e.match(/(youku|tudou|qiyi|sohu|qq|letv)/) && !!e.match(/\.swf/)
                },
                k = function (t) {
                    var n = $('input[name="sync"]:checked'),
                        a = [
                        ];
                    n.size() && (a = (a = n.map(function () {
                        return $(this).val()
                    })).get());
            ...
            function x(e, t, n, a) {
                return e.url_pattern ? (t = t || 600, n = n || t * e.original_height / e.original_width, a = /.gif$/.test(e.ident) ? 'gif' : 'jpg', e.url_pattern.replace('{width}', Math.round(t)).replace('{height}', Math.round(n)).replace('{format}', a))  : ''
            }
            function S() {
                e.recipe.steps.push({
                    text: '',
            ...
            function C(t) {
                if ((t = {
                    name: t.name,
                    unit: t.unit
                }).name && t.unit) for (var n in e.recipe.ings) {
                    var a = e.recipe.ings[n];
                    if (!a.name && !a.unit) return void (e.recipe.ings[n] = t)
                }
            ...
            var A = n.document.createElement('a');
            function D() {
                angular.element('<input type=file>').hide().appendTo('body').click().change(function () {
                    var t = this.files[0];
                    t && (e.uploadVideoProgress = '处理视频中……', e.uploadVideoPending = !0, o.uploadVideo(t).then(function (t) {
                        A.setAttribute('href', t.videoUrl),
                            A.setAttribute('href', A.href),
                            e.recipe.video_ident = A.pathname.slice(1),
                            e.recipe.vod_video = {
                                id: t.fileId,
                                url: t.videoUrl,
                                cover: '',
                        ...
                        angular.isString(e) ? alert('videoFile必须为视频文件' === e ? '请选择视频文件' : e)  : angular.isObject(e) && e.type && e.msg ? alert('上传失败，文件类型：' + e.type + '，失败原因:' + e.msg)  : alert('上传失败，请稍后重试！')
                    }, function (t) {
                        T(),
                            t.curr ? e.uploadVideoProgress = '上传视频中……（' + a('number') (100 * t.curr, 0) + '%）' : e.uploadVideoProgress = '处理视频中……（' + a('number') (100 * t.shacurr, 0) + '%）'
                    }).finally (function () {
                        e.uploadVideoProgress = '',
                            e.uploadVideoPending = !1
                    }))
        ...
        angular.module('app', [
            ...
            angular.module('app').constant('DEFAULT_EMPTY_RECIPE', {
                ...
                exclusive: window.default_exclusive_recipe,
                is_fullscreen: window.is_kfun_recipe_provider,
                video_address: '',
                syncs: [
                ],
                ...
                allow_adaptation: window.default_allow_adaptation
            }),
