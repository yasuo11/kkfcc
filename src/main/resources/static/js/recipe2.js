(function () {
    var h = {
        ...
        c = {
            id: 'ecd4feb5c351cc02583045a5813b5142',
            dm: [
                'xiachufang.com',
    ...
    mt.lang.M = function (b, a) {
        ...
        else for (var d = 0; d < b.length; d++) if (b[d] === a) {
            e = s;
            break
        }
        return e
    ...
    (function () {
        ...
        mt.e.Z = function (a, b) {
            ...
            for (; a.parentNode != t; ) {
                ...
                if ((n = '' !== a.id) && b) {
                    ...
                    d.unshift(encodeURIComponent(String(a.nodeName).toLowerCase()) + (1 < l ? '[' + m + ']' : ''));
                a = a.parentNode
            }
            g.push(d.join('>'));
            return g
        ...
        mt.e.getAttribute = function (a, b) {
            ...
            if (!d && a.attributes && a.attributes.length) for (var g = a.attributes, l = g.length, m = 0; m < l; m++) g[m].nodeName === b && (d = g[m].nodeValue);
            return d
        };
        mt.e.K = function (a) {
            var b = 'document';
        ...
        mt.e.Qa = function (a) {
            var b = mt.e.K(a);
            'input' === b && ('button' === a.type || 'submit' === a.type) ? a = a.value || '' : 'img' === b ? (b = mt.e.getAttribute, a = b(a, 'alt') || b(a, 'title') || b(a, 'src'))  : a = 'body' === b || 'html' === b ? [
                '(hm-default-content-for-',
                b,
                ')'
            ].join('')  : mt.e.Wa(a);
        ...
        (function () {
            (mt.e.ib = function () {
                ...
                (function () {
                    if (!d) if (d = s, 'complete' === document.readyState) a.O = s;
                    else if (document.addEventListener) document.addEventListener('DOMContentLoaded', l, u),
        ...
        return function (d) {
            switch (typeof d) {
                ...
                default:
                    ...
                    n = mt.l.stringify;
                    for (l in d) if (Object.prototype.hasOwnProperty.call(d, l)) switch (f = d[l], typeof f) {
                        case 'undefined':
                        case 'unknown':
                        case 'function':
                            break;
    ...
    mt.localStorage.set = function (b, a, e) {
        var d = new Date;
        d.setTime(d.getTime() + e || 31536000000);
        try {
    ...
    mt.localStorage.get = function (b) {
        if (window.localStorage) {
            ...
            return mt.localStorage.h.load(document.location.hostname),
                mt.localStorage.h.getAttribute(b)
        } catch (d) {
        }
        return t
    };
    mt.localStorage.remove = function (b) {
        if (window.localStorage) window.localStorage.removeItem(b);
            ...
            mt.localStorage.h.load(document.location.hostname),
                mt.localStorage.h.removeAttribute(b),
    ...
    h.o = {
        ...
        z: Math.round( + new Date / 1000) % 65535,
    ...
    (function () {
        function b(b, d) {
            ...
            a.d(d, 'Function') && (g.readyState ? g.onreadystatechange = function () {
                    if ('loaded' === g.readyState || 'complete' === g.readyState) g.onreadystatechange = t,
                        d()
                }
                : g.onload = function () {
                    d()
        ...
        var b = mt.lang,
            ...
            f = {
                    ...
                    return function (p) {
                        if (h.b && h.b.D && c.aet && c.aet.length) {
                            ...
                            if (k) {
                                ...
                                if (a.getAttribute(k, g.la) == t) if (q) f.R(f.X(k, p));
                                else {
                                    var e = a.K(k);
                                    if (b.M(d, '*') || b.M(d, e)) f.R(f.X(k, p));
                                    else for (; k.parentNode != t; ) {
                                        var q = k.parentNode,
                                            e = a.K(q),
                                            v = 'a' === e && b.M(d, 'a') ? s : u,
                                            e = 'button' === e && b.M(d, 'button') ? s : u,
                                            y = a.getAttribute(q, g.ma) != t ? s : u;
                                        if (a.getAttribute(q, g.la) == t && (v || e || y)) {
                                            f.R(f.X(q, p));
                                            break
                                        }
                                        k = k.parentNode
                ...
                X: function (p, k) {
                    ...
                    'click' === k.type ? q = d.sa ? k.clientY + Math.max(document.documentElement.scrollTop, document.body.scrollTop)  : k.pageY : 'touchend' === k.type && (k.ea && b.d(k.ea.changedTouches, 'Array') && k.ea.changedTouches.length) && (q = k.ea.changedTouches[0].pageY);
                    e.tb = q;
                    return e
                },
                R: function (a) {
                ...
                S: function (a) {
                    a.length > g.U || (encodeURIComponent(n.join('!') + a).length > g.U && (f.H(n.join('!')), n = [
                    ]), n.push(a))
                },
                H: function (a) {
                    h.b.a.et = 5;
    ...
    (function () {
        var b = mt.event,
            ...
            n = {
                ...
                Ba: function (a) {
                    n.S([ + new Date - (h.b.r !== r ? h.b.r : g),
                        a].join('*'))
                },
                S: function (a) {
                    if (encodeURIComponent(l.join('!') + a).length > e.U || 3 < l.length) n.H(l.join('!')),
                        l = [
                        ];
                    l.push(a)
                },
    ...
    (function () {
        ...
        function d(b) {
            if (!('focus' == b.type || 'blur' == b.type) || !(b.target && b.target != window)) p = 'focus' == b.type || 'focusin' == b.type ? s : u,
                a()
        }
        var g = mt.event,
            l = h.A,
                ...
                fb: function (d) {
                    if ((window._dxt === r || b.d(window._dxt, 'Array')) && 'undefined' !== typeof h.b) {
                        ...
                        e([a.protocol,
                            ...
                            c.id,
                            '&dm=',
                            encodeURIComponent(l)].join(''), d)
                    }
                },
                rb: function (a) {
                    if (b.d(a, 'String') || b.d(a, 'Number')) window._dxt = window._dxt || [
                    ],
                        window._dxt.push(['_setUserId',
                            a])
                }
            };
        return h.Ha = d
        ...
        function b(a, b, e, q) {
            if (!(a === r || b === r || q === r)) {
                if ('' === a) return [b,
                    ...
                    q].join('*');
                a = String(a).split('!');
                for (var d, f = u, y = 0; y < a.length; y++) if (d = a[y].split('*'), String(b) === d[0]) {
                    d[1] = e;
                    d[2] = q;
                    a[y] = d.join('*');
                    f = s;
            ...
            f = {
                ...
                init: function () {
                    ...
                    m.c('stag-b', function () {
                        ...
                        h.b.a.ct = [
                            decodeURIComponent(h.b.getData('Hm_ct_' + c.id) || ''),
                            f.m.ia,
                            f.m.page
                        ].join('!')
                    });
                ...
                Ma: function () {
                    if (0 < f.F.length) for (var a = 0, b = f.F.length; a < b; a++) f.fa(f.F[a]);
                    f.F = t
                },
                fa: function (a) {
                    var b = a[0];
                ...
                _setAutoPageview: function (a) {
                    if (1 < a.length && (a = a[1], u === a || s === a)) f.f |= 2,
                        h.b.qa = a
                },
                ...
                _trackRTPageview: function (b) {
                    b = b[1];
                    e.d(b, 'Object') && (a(b), b = d.stringify(b), 512 >= encodeURIComponent(b).length && (f.f |= 64, h.b.a.rt = b))
                },
                _trackRTEvent: function (b) {
                    ...
                    if (e.d(b, 'Object')) {
                        ...
                        else for (var m = Math.ceil(m / 900), q = 'block|' + Math.round(Math.random() * l.da).toString(16) + '|' + m + '|', x = [
                        ], v = 0; v < m; v++) x.push(v),
                            x.push(b.substring(900 * v, 900 * v + 900)),
                            g.call(this, q + x.join('|')),
                            x = [
                            ]
                    }
                },
    ...
    (function () {
        function b() {
            ...
            }, this.ra = this.qa = s, this.D = k.D, this.na = g.aa() && 0 < c.aet.length ? c.aet.split(',')  : '', this.$ = u, this.init())
        }
        var a = mt.url,
            e = mt.ya,
            d = mt.ga,
        ...
        b.prototype = {
            ...
            J: function () {
                for (var a = document.location.hostname, b = 0, d = c.dm.length; b < d; b++) if (this.ba(a, c.dm[b])) return c.dm[b].replace(/(:\d+)?[/?#].*/, '');
                return a
            },
            W: function () {
            ...
            pb: function () {
                ...
                13 === k.w.length && (k.w = Math.round(k.w / 1000));
                b = this.Va();
                a = 4 !== b ? 1 : 0;
                if (d = this.getData('Hm_lvt_' + c.id)) {
                    e = d.split(',');
                    for (f = e.length - 1; 0 <= f; f--) 13 === e[f].length && (e[f] = '' + Math.round(e[f] / 1000));
                    for (; 2592000 < k.s - e[0]; ) e.shift();
                    f = 4 > e.length ? 2 : 3;
                ...
                this.setData('Hm_lpvt_' + c.id, k.s);
                d = l.gb(this.J(), this.W());
                if (0 === c.nv && this.N(document.location.href) && ('' === document.referrer || this.N(document.referrer))) a = 0,
                    b = 4;
                this.a.nv = a;
                this.a.st = b;
                this.a.cc = d;
            ...
            ob: function () {
                for (var a = [
                ], b = this.a.et, d = + new Date, e = 0, f = k.za.length; e < f; e++) {
                    var g = k.za[e],
                        l = this.a[g];
            ...
            nb: function () {
                ...
                if (b.length) for (var g = function (b) {
    ...
    }) (); var B = h.o, C = h.load; c.pt && C([B.protocol,
        '//ada.baidu.com/phone-tracker/insert_bdtj?sid=',
        c.pt].join('')); (function () {
        var b = mt.g,
            a = mt.lang,
            e = mt.event,
        ...
        if ('undefined' !== typeof h.b && (c.med || (!b.sa || 7 < b.eb) && c.cvcc)) {
                ...
                k = function (b, e) {
                    ...
                    if (e) {
                        var k = e.getAttribute('href'),
                            ...
                            n = e.getAttribute('id') || '';
                        m.test(k) ? (f.sn = 'mediate', f.snv = k)  : a.d(l, 'String') && m.test(l) && (f.sn = 'wrap', f.snv = l);
                        f.id = n
                    }
                    h.b.a.et = 86;
            ...
            if (c.med) l = '/zoosnet',
                g = 'swt',
                m = /swt|zixun|call|chat|zoos|business|talk|kefu|openkf|online|\/LR\/Chatpre\.aspx/i,
                n = {
                    click: function () {
                        for (var a = [
                        ], b = f(document.getElementsByTagName('a')), b = [
                        ].concat.apply(b, f(document.getElementsByTagName('area'))), b = [
                        ].concat.apply(b, f(document.getElementsByTagName('img'))), d, e, g = 0, k = b.length; g < k; g++) d = b[g],
                            e = d.getAttribute('onclick'),
                            d = d.getAttribute('href'),
                        (m.test(e) || m.test(d)) && a.push(b[g]);
                        return a
                    }
                };
            else if (c.cvcc) {
                ...
                n = {
                    click: function () {
                        ...
                        ].concat.apply(b, f(document.getElementsByTagName('img'))), d, e, g, k = 0, l = b.length; k < l; k++) d = b[k],
                            m !== r ? (e = d.getAttribute('onclick'), g = d.getAttribute('href'), w ? (d = d.getAttribute('id'), (m.test(e) || m.test(g) || w.test(d)) && a.push(b[k]))  : (m.test(e) || m.test(g)) && a.push(b[k]))  : w !== r && (d = d.getAttribute('id'), w.test(d) && a.push(b[k]));
                        return a
                    }
                }
            }
            if ('undefined' !== typeof n && 'undefined' !== typeof m) {
                ...
                l += /\/$/.test(l) ? '' : '/';
                var x = function (b, d) {
                    if (q === d) return k(l + b, d),
                        u;
                    if (a.d(d, 'Array') || a.d(d, 'NodeList')) for (var e = 0, f = d.length; e < f; e++) if (q === d[e]) return k(l + b + '/' + (e + 1), d[e]),
                        u
                };
                e.c(document, 'mousedown', function (b) {
                    ...
                    }); q && q !== document && p(d, x) !== u; ) q = q.parentNode
                })
            }
        }
    }) (); (function () {
